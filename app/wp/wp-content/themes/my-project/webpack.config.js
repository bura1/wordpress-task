...
module.exports = (env, argv) => {
	...
	const projectConfig = {
		config: {
			...
			projectUrl: 'dev.wordpress.com', // Used for providing browsersync functionality.
			projectPath: 'wp-content/themes/my-project', // Project path relative to project root.
		},
	};
